#Copy and paste this code into (completely overwriting) the file src/xarm/xarm_ros2/xarm_moveit_config/launch/demo/demo_fake.launch.py
# Then build, source, and run `ros2 run xarm_moveit_config demo_fake.launch.py` to see single arm planning for a pose
import os
...
def launch_setup(context, *args, **kwargs):
    ...
    vader_node = Node(
        package='vader_planning',
        executable='vader_helloworld',
        output='screen',
        parameters=[
