...
const double MIN_BLOCK_SIZE = 0.02;
const double MAX_BLOCK_SIZE = 0.04;
const double WORKSPACE_RADIUS = 1.2;
const double MIN_HEIGHT = 0.1;
const double MAX_HEIGHT = 1.0;
const double ARM_SAFETY_RADIUS = 0.15;
const double BLOCK_SAFETY_MARGIN = 0.05;
...
void PlannerTester::runParameterTests(int num_trials)
{
    ...
    std::string csv_path = ros::package::getPath("vader_planner") + "/ompl_testing_results.csv";
    std::ofstream csv_file(csv_path);
